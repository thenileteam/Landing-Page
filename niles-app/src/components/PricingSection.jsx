...
const PricingSection = () => {
  return (
    <section  id="#setup"className=" section-spacing bg-myCustomColor-lighterGreen mt-96 rounded-t-semi-round">
      ...
      <button type="button" className="bg-primary mt-16 mx-auto  block font-bold text-pry1 w-32 py-3 rounded-very-round  hover:bg-pry1 hover:text-primary transitions">Join Now</button>
    </section>
  );
};
