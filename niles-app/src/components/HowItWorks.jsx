  ...
  return (
    <>
      <section id="howItWorks" className="relative section-spacing">
        <div className="overlay absolute z-10 left-0 right-0 -top-7  lg:-top-5 h-8 rounded-t-very-round bg-pry1"></div>
        <div className=" bg-pry1">
          ...
          <div className="mt-20 flex-container items-center flex-col gap-10 lg:gap-5 lg:flex-row ">
            <div className="lg:w-2/5 flex items-start gap-3">
              ...
              <img
                src={dots}
                alt="connecting dots for each step"
                loading="lazy"
                className="h-2/3 lg:h-full mt-1"
              />
              <div className="steps">
